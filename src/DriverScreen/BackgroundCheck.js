...
const styles = StyleSheet.create({
  ...
  textInput: {
    backgroundColor: 'white', marginBottom: 10, borderRadius: 10, elevation: 5, shadowColor: Colors.primary, paddingHorizontal: 15, fontFamily: 'Montserrat-Regular', color: 'black'
  }
})
