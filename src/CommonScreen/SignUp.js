          ...
          <ImageBackground style={{width: '100%', height: '100%', flex: 1}} source={require('../../Assets/imageBG.png')}>
            ...
            <View style={{padding: 21, alignItems: 'center', justifyContent: 'flex-end', flex: 1}}>
              ...
              <View style={styles.inputs_container}>
                <CustomInput label="FULL NAME" iconSource={require(`../../Assets/icon/user.png`)} setState={({text}) => setName(text)} state={name} />
                <CustomInput
                  label="EMAIL ADDRESS"
                ...
                <CustomInput
                  ...
                  state={password}
                />
                <CtaButton title="Continue" primary onPress={() => navigation.navigate('ENTER OTP')} />
              </View>
              <TouchableOpacity
