        ...
        return (
            ...
            <View style={{
                ...
                <View style={{ justifyContent: 'flex-end', alignItems: 'center', }}>
                    <Text style={{ color: '#fff', textAlign: 'center', marginBottom: 5, fontSize: 18 }}>Hello Well come to suds-2-U</Text>
                    ...
                    <View style={{ alignItems: 'center', width: '100%', marginBottom: 5, marginTop: 5, padding: 5 }}>
                        ...
                        // disabled={this.state.disableBtn}
                        >
                            <Text style={{ fontSize: 18, textAlign: 'center', color: '#000',  }}>Car Washer</Text>
                        </TouchableOpacity>
