...
const ListEmpty = ({netInfo, retry, emptyMsg, color='black', opacity=0.1}) => {
  return (
    <View style={{alignItems: 'center', padding: 20}}>
      <Icon color={color} style={{opacity: opacity}} size={100} name={netInfo.isConnected ? 'list-alt' : 'perm-scan-wifi'} />
      <Text style={{fontSize: 32, fontWeight: 'bold', opacity: opacity, color: color}}>
