      ...
      return (
        <View style={{flex:1,backgroundColor:'#FFF'}}>
             ...
             <View style={{padding:21,alignItems:'center'}}>
               <View style={{backgroundColor:'#fff',alignItems:'center', width:'100%',height:130,padding:18,
               borderRadius:10,shadowOpacity:0.8,shadowColor:'#aaa', shadowOffset: { width: 1, height: 1 },
}}>
...
<View style={{backgroundColor:'#fff',alignItems:'center', width:'100%',height:60,padding:5,justifyContent:'center',marginTop:10,marginBottom:10,
               borderRadius:10,shadowOpacity:0.8,shadowColor:'#aaa', shadowOffset: { width: 1, height: 1 },
}}>
