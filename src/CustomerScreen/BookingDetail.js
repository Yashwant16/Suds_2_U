...
<Text style={{alignItems:'flex-end',color:'#e28c39',fontWeight:'500',fontSize:16}}></Text>
</View>
...
<Text style={{textAlign:'center',fontWeight:'bold',marginTop:5,marginLeft:5,fontSize:14,color:Colors.dark_orange}}>JANUARY 29,2021 AT 4:00 PM</Text>
<View style={{width:'100%',height:0.5,backgroundColor:'#aaa',marginVertical:10}}/>

<Text style={{textAlign:'center',color:'#fff', marginTop:5,marginLeft:5,fontSize:16,fontWeight:'bold'}}>LEAVE A TIP</Text>

<View style={{flexDirection:'row',justifyContent:'space-between'}}> 
<TouchableOpacity style={styles.payment_btn}>
<Text style={{textAlign:'center',fontWeight:'bold',marginTop:5,marginLeft:5,fontSize:16}}>$10</Text>
</TouchableOpacity>
<TouchableOpacity style={styles.payment_btn}>
<Text style={{textAlign:'center',fontWeight:'bold',marginTop:5,marginLeft:5,fontSize:16}}>$20</Text>
</TouchableOpacity>
<TouchableOpacity style={styles.payment_btn}>
<Text style={{textAlign:'center',fontWeight:'bold',marginTop:5,marginLeft:5,fontSize:16}}>$30</Text>
</TouchableOpacity>
<TouchableOpacity style={styles.payment_btn}>
<Text style={{textAlign:'center',fontWeight:'bold',marginTop:5,marginLeft:5,fontSize:16}}>Custom</Text>
</TouchableOpacity>
</View>
<Text style={{textAlign:'center',color:'#fff', marginTop:5,marginLeft:5,fontSize:16,fontWeight:'bold',marginVertical:15,marginTop:10}}>Rate Our car Washer</Text>

<View style={{backgroundColor:'#fff',width:'90%',height:130,borderRadius:5}}> 

<View style={{flexDirection:'row',padding:10,alignSelf:'center'}}>
<Image style={{ width: 25, height: 25, tintColor:Colors.dark_orange, marginLeft: 10 }} source={require('../../Assets/review.png')} />
<Image style={{ width: 25, height: 25, tintColor:Colors.dark_orange, marginLeft: 10 }} source={require('../../Assets/review.png')} />
<Image style={{ width: 25, height: 25, tintColor:Colors.dark_orange, marginLeft: 10 }} source={require('../../Assets/review.png')} />
<Image style={{ width: 25, height: 25, tintColor:Colors.dark_orange, marginLeft: 10 }} source={require('../../Assets/review.png')} />
<Image style={{ width: 25, height: 25, tintColor:Colors.dark_orange, marginLeft: 10 }} source={require('../../Assets/review.png')} />
</View>
<Text style={{color:'#AAA', marginTop:5,marginLeft:20,fontSize:14,fontWeight:'bold'}}>WRITE YOUR COMMENT</Text>
<TextInput
